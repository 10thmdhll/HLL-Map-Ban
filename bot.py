...
# ─── Autocomplete handlers attached to the single ban_map command below
# Defined via @ban_map.autocomplete on the second ban_map command
...
# ─── Slash Commands, description="Create a new match")
