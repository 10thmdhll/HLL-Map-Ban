...
def create_ban_status_image(
    ...
    # draw banner, headers, rows (omitted for brevity)...
...
async def ban_map(
    ...
    # Check for final‐two‐same‐map BEFORE applying new ban
    combos_pre = [
        (m,t,s)
    ...
    # Apply this ban and the auto‐ban
